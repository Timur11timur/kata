...
class StringCalculatorTest extends TestCase
{
    ...
    /** @test */
    public function it_finds_the_sum_for_single_number()
    {
        $calculator = new StringCalculator();
    ...
    /** @test */
    public function it_finds_the_sum_for_two_numbers()
    {
        $calculator = new StringCalculator();
    ...
    /** @test */
    public function it_finds_the_sum_for_any_amount_of_numbers()
    {
        $calculator = new StringCalculator();
